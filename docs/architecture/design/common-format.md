...
Our format is inspired by [:octicons-link-external-16: Frictionless DataPackage format](https://frictionlessdata.io/), which features the following:
...
### Tables ([:fontawesome-brands-github: `owid.catalog.Table`](https://github.com/owid/etl/blob/master/lib/catalog/owid/catalog/tables.py))
...
### Variables ([:fontawesome-brands-github:  `owid.catalog.Variable`](https://github.com/owid/etl/blob/master/lib/catalog/owid/catalog/variables.py))
