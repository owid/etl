...
- `static`: For static images (PNG/SVG). Only writes local files; no flag needed.
- `bespoke`: For the data feeds of bespoke interactive visualizations. Uploads to R2; run with `--export`.
