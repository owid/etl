...
function create_queries() - This function includes all the keywords for each cause of death and creates a dictionary with keywords, combinations, and terms to exclude.
function create_query_str(query_dict, proximity=1000) - This function takes the query dictionary for each cause of death (created in create_queries) and creates a query string, including both the keywords and combinations of keywords.
