    ...
    data = pi.input_group(
        ...
        [
            ...
            pi.checkbox(
                ...
                name="options",
                value=[Options.ADD_TO_DAG.value, Options.GENERATE_NOTEBOOK.value],
            ),
        ],
    )
    form = MeadowForm(**data)  # type: ignore
...
"""
        ...
        if dag_content:
            po.put_success(
                po.put_markdown(f"Steps in dag.yml were successfully generated")
            )
