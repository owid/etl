...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_2665_economic_impacts_of_1_5c__pretis_et_al_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_2665_economic_impacts_of_1_5c__pretis_et_al_config.json")
    snap_config.pull()
    ...
    meta.short_name = "economic_impacts_of_1_5c__pretis_et_al"
