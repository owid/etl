...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_5298_coral_bleaching_events_by_enso_phase__hughes_et_al__2018_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_5298_coral_bleaching_events_by_enso_phase__hughes_et_al__2018_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "coral_bleaching_events_by_enso_phase__hughes_et_al__2018"
