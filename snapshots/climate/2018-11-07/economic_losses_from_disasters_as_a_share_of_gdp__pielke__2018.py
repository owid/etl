...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_3093_economic_losses_from_disasters_as_a_share_of_gdp__pielke__2018_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_3093_economic_losses_from_disasters_as_a_share_of_gdp__pielke__2018_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "economic_losses_from_disasters_as_a_share_of_gdp__pielke__2018"
