...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_2731_parties_to_montreal_protocol__unep__2023_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_2731_parties_to_montreal_protocol__unep__2023_config.json")
    snap_config.pull()
    ...
    meta.short_name = "parties_to_montreal_protocol__unep__2023"
