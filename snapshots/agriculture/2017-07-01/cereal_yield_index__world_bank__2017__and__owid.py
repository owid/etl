...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_579_cereal_yield_index__world_bank__2017__and__owid_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_579_cereal_yield_index__world_bank__2017__and__owid_config.json")
    snap_config.pull()
    ...
    meta.short_name = "cereal_yield_index__world_bank__2017__and__owid"
