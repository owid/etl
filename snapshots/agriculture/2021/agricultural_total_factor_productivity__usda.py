...
def main(upload: bool) -> None:
    ...
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5491_agricultural_total_factor_productivity__usda_config.json")
    snap_config.pull()
    ...
    meta.short_name = "agricultural_total_factor_productivity__usda"
