...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5441_long_term_land_use__taylor_and_rising_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5441_long_term_land_use__taylor_and_rising_config.json")
    snap_config.pull()
    ...
    meta.short_name = "long_term_land_use__taylor_and_rising"
