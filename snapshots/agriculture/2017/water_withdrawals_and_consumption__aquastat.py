...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_1014_water_withdrawals_and_consumption__aquastat_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_1014_water_withdrawals_and_consumption__aquastat_config.json")
    snap_config.pull()
    ...
    meta.short_name = "water_withdrawals_and_consumption__aquastat"
