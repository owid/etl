...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_924_fertilizer_use_per_hectare_of_land__fao__and__federico_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_924_fertilizer_use_per_hectare_of_land__fao__and__federico_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "fertilizer_use_per_hectare_of_land__fao__and__federico"
