...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_666_half_index__land_use__alexander_et_al__2016_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_666_half_index__land_use__alexander_et_al__2016_config.json")
    snap_config.pull()
    ...
    meta.short_name = "half_index__land_use__alexander_et_al__2016"
