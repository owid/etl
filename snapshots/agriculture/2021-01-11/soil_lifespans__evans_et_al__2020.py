...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5239_soil_lifespans__evans_et_al__2020_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5239_soil_lifespans__evans_et_al__2020_config.json")
    snap_config.pull()
    ...
    meta.short_name = "soil_lifespans__evans_et_al__2020"
