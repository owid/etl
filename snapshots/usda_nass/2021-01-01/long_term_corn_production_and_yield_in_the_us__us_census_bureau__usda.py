...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_5455_long_term_corn_production_and_yield_in_the_us__us_census_bureau__usda_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_5455_long_term_corn_production_and_yield_in_the_us__us_census_bureau__usda_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "long_term_corn_production_and_yield_in_the_us__us_census_bureau__usda"
