...
After running this script, add the long.csv and the current.csv file to snapshots (change the date in the path for future updates):
    etls lgbt_rights/2023-04-13/equaldex --path-to-file snapshots/lgbt_rights/2023-04-13/long.csv
    etls lgbt_rights/2023-04-13/equaldex_current --path-to-file snapshots/lgbt_rights/2023-04-13/current.csv
