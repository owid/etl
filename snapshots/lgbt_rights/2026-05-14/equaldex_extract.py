...
After running this script, add the long.csv and the current.csv file to snapshots (change the date in the path for future updates):
    etls lgbt_rights/2026-05-14/equaldex --path-to-file snapshots/lgbt_rights/2026-05-14/long.csv
    etls lgbt_rights/2026-05-14/equaldex_current --path-to-file snapshots/lgbt_rights/2026-05-14/current.csv
    etls lgbt_rights/2026-05-14/equaldex_indices --path-to-file snapshots/lgbt_rights/2026-05-14/indices.csv
