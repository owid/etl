...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_2760_terrain_ruggedness_index__nunn_and_puga__2012_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_2760_terrain_ruggedness_index__nunn_and_puga__2012_config.json")
    snap_config.pull()
    ...
    meta.short_name = "terrain_ruggedness_index__nunn_and_puga__2012"
