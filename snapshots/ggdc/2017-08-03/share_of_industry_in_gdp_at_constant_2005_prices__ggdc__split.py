...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_3010_share_of_industry_in_gdp_at_constant_2005_prices__ggdc__split_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_3010_share_of_industry_in_gdp_at_constant_2005_prices__ggdc__split_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "share_of_industry_in_gdp_at_constant_2005_prices__ggdc__split"
