...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_270_international_historical_statistics__deaths_per_1_000__brian_mitchell__2013_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_270_international_historical_statistics__deaths_per_1_000__brian_mitchell__2013_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "international_historical_statistics__deaths_per_1_000__brian_mitchell__2013"
