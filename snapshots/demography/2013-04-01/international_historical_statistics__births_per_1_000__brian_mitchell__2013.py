...
def main(upload: bool) -> None:
    ...
    snap_config = Snapshot(
        "backport/latest/dataset_269_international_historical_statistics__births_per_1_000__brian_mitchell__2013_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "international_historical_statistics__births_per_1_000__brian_mitchell__2013"
