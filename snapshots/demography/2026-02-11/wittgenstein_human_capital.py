...
INSTRUCTIONS:
- Download data from WCDE server with `get_data` and `get_data_historical` functions:
    ```
    get_data("data/wittgenstein_human_capital")
    get_data_historical("data/wittgenstein_human_capital_historical")
    ```
- Run this snapshot script with:
    ```
...
URL_SERVER = "https://wicshiny2023.iiasa.ac.at/wcde-data/wcde-v32-batch"
INDICATORS = [
    "asfr",
    "assr",
    "bmys",
...
def main(path_to_file: Optional[str], path_to_file_historical: str, upload: bool) -> None:
    ...
    ```
    python snapshots/demography/2026-02-11/wittgenstein_human_capital.py --path-to-file <path_to_file> --path-to-file-historical <path_to_file_historical>
    ```
    """
