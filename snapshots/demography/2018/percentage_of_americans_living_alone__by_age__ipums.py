...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_2891_percentage_of_americans_living_alone__by_age__ipums_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_2891_percentage_of_americans_living_alone__by_age__ipums_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "percentage_of_americans_living_alone__by_age__ipums"
