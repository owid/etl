...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5240_labour_force_dependency_ratio__iiasc_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5240_labour_force_dependency_ratio__iiasc_config.json")
    snap_config.pull()
    ...
    meta.short_name = "labour_force_dependency_ratio__iiasc"
