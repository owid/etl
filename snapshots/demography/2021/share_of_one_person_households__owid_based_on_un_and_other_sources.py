...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_4864_share_of_one_person_households__owid_based_on_un_and_other_sources_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_4864_share_of_one_person_households__owid_based_on_un_and_other_sources_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "share_of_one_person_households__owid_based_on_un_and_other_sources"
