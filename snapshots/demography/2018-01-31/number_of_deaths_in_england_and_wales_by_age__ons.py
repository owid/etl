...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_1935_number_of_deaths_in_england_and_wales_by_age__ons_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_1935_number_of_deaths_in_england_and_wales_by_age__ons_config.json")
    snap_config.pull()
    ...
    meta.short_name = "number_of_deaths_in_england_and_wales_by_age__ons"
