...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_655_child_labor_in_us__long__1958_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_655_child_labor_in_us__long__1958_config.json")
    snap_config.pull()
    ...
    meta.short_name = "child_labor_in_us__long__1958"
