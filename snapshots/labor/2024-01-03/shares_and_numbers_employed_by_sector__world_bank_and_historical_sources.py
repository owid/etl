...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_5516_shares_and_numbers_employed_by_sector__world_bank_and_historical_sources_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_5516_shares_and_numbers_employed_by_sector__world_bank_and_historical_sources_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "shares_and_numbers_employed_by_sector__world_bank_and_historical_sources"
