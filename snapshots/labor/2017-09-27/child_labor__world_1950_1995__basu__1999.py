...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_169_child_labor__world_1950_1995__basu__1999_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_169_child_labor__world_1950_1995__basu__1999_config.json")
    snap_config.pull()
    ...
    meta.short_name = "child_labor__world_1950_1995__basu__1999"
