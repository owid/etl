...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_4246_job_search_methods_us__pew_research_center__2015_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_4246_job_search_methods_us__pew_research_center__2015_config.json")
    snap_config.pull()
    ...
    meta.short_name = "job_search_methods_us__pew_research_center__2015"
