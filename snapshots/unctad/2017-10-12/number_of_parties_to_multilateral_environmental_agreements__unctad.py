...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_965_number_of_parties_to_multilateral_environmental_agreements__unctad_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_965_number_of_parties_to_multilateral_environmental_agreements__unctad_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "number_of_parties_to_multilateral_environmental_agreements__unctad"
