...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_1847_clark__fleche__and__senik__happiness_inequality_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_1847_clark__fleche__and__senik__happiness_inequality_config.json")
    snap_config.pull()
    ...
    meta.short_name = "clark__fleche__and__senik__happiness_inequality"
