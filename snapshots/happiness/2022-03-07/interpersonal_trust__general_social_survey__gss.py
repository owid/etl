...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_2971_interpersonal_trust__general_social_survey__gss_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_2971_interpersonal_trust__general_social_survey__gss_config.json")
    snap_config.pull()
    ...
    meta.short_name = "interpersonal_trust__general_social_survey__gss"
