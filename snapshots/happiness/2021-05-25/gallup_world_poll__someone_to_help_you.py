...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5314_gallup_world_poll__someone_to_help_you_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5314_gallup_world_poll__someone_to_help_you_config.json")
    snap_config.pull()
    ...
    meta.short_name = "gallup_world_poll__someone_to_help_you"
