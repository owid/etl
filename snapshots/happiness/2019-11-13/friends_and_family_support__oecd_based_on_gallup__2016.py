...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_4253_friends_and_family_support__oecd_based_on_gallup__2016_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_4253_friends_and_family_support__oecd_based_on_gallup__2016_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "friends_and_family_support__oecd_based_on_gallup__2016"
