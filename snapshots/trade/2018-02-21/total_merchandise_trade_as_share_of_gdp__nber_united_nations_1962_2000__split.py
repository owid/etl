...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_3019_total_merchandise_trade_as_share_of_gdp__nber_united_nations_1962_2000__split_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_3019_total_merchandise_trade_as_share_of_gdp__nber_united_nations_1962_2000__split_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "total_merchandise_trade_as_share_of_gdp__nber_united_nations_1962_2000__split"
