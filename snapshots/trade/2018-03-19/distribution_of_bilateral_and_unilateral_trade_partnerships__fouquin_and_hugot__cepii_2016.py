...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_2830_distribution_of_bilateral_and_unilateral_trade_partnerships__fouquin_and_hugot__cepii_2016_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_2830_distribution_of_bilateral_and_unilateral_trade_partnerships__fouquin_and_hugot__cepii_2016_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "distribution_of_bilateral_and_unilateral_trade_partnerships__fouquin_and_hugot__cepii_2016"
