...
def main(upload: bool) -> None:
    ...
    snap = Snapshot("trade/2018-03-19/split_of_exports_to_different_country_groups__owid_calculations_based_on_fouquin_and_hugot__cepii_2016__dyadic_data.feather")
