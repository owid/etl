"""Script to create a snapshot of dataset 'Long-term wheat yields, Understanding Green Revolutions, Bayliss-Smith &
Wanmali (1984)'.
...
def main(upload: bool) -> None:
    ...
    df_wheat_yields_in_europe = pd.DataFrame.from_records(
        ...
        data=[
            ...
            ("Romania", None, 12.9, 8.0, 10.2, 25.8),
            ("Hungary", None, 13.2, 11.3, 13.8, 38.6),
            ("Bulgaria", None, 6.2, 9.2, 12.4, 38.3),
    ...
    # Create snapshot.
    snap.create_snapshot(data=df_wheat_yields_in_europe, upload=upload)
