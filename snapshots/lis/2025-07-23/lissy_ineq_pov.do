...
9. Paste the content into the recently created files. The names of the files and the settings related to them are:
	...
	- lis_keyvars_equivalized_adults.csv (menu_option = 1, equivalized = 1, age = "adults")
	- lis_keyvars_pc_adults.csv (menu_option = 1, equivalized = 0, age = "adults")
	- lis_abs_poverty_equivalized_adults.csv (menu_option = 2, equivalized = 1, age = "adults")
	- lis_abs_poverty_pc_adults.csv (menu_option = 2, equivalized = 0, age = "adults")
	- lis_distribution_equivalized_adults.csv (menu_option = 3, equivalized = 1, age = "adults")
	- lis_distribution_pc_adults.csv (menu_option = 3, equivalized = 0, age = "adults")
...
11. Once all the files have been created, copy them into the lis snapshot directory in the ETL, run concat_files.py and then update the snapshot, by using these comands one by one:
	python snapshots/lis/2025-07-23/concat_files.py
	python snapshots/lis/2025-07-23/lis_keyvars.py --path-to-file snapshots/lis/2025-07-23/lis_keyvars.csv
	python snapshots/lis/2025-07-23/lis_abs_poverty.py --path-to-file snapshots/lis/2025-07-23/lis_abs_poverty.csv
	python snapshots/lis/2025-07-23/lis_distribution.py --path-to-file snapshots/lis/2025-07-23/lis_distribution.csv
	python snapshots/lis/2025-07-23/lis_percentiles.py --path-to-file snapshots/lis/2025-07-23/lis_percentiles.csv
	python snapshots/lis/2025-07-23/lis_keyvars_adults.py --path-to-file snapshots/lis/2025-07-23/lis_keyvars_adults.csv
	python snapshots/lis/2025-07-23/lis_abs_poverty_adults.py --path-to-file snapshots/lis/2025-07-23/lis_abs_poverty_adults.csv
	python snapshots/lis/2025-07-23/lis_distribution_adults.py --path-to-file snapshots/lis/2025-07-23/lis_distribution_adults.csv
	python snapshots/lis/2025-07-23/lis_percentiles_adults.py --path-to-file snapshots/lis/2025-07-23/lis_percentiles_adults.csv
