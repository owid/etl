...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_663_long_term_energy_transitions__energy_history__harvard__2016_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_663_long_term_energy_transitions__energy_history__harvard__2016_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "long_term_energy_transitions__energy_history__harvard__2016"
