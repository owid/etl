...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_955_coal_production__the_shift_project_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_955_coal_production__the_shift_project_config.json")
    snap_config.pull()
    ...
    meta.short_name = "coal_production__the_shift_project"
