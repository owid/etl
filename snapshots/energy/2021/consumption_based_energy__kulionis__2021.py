...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5403_consumption_based_energy__kulionis__2021_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5403_consumption_based_energy__kulionis__2021_config.json")
    snap_config.pull()
    ...
    meta.short_name = "consumption_based_energy__kulionis__2021"
