...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_951_coal_output_and_employment_in_uk__beis__2020_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_951_coal_output_and_employment_in_uk__beis__2020_config.json")
    snap_config.pull()
    ...
    meta.short_name = "coal_output_and_employment_in_uk__beis__2020"
