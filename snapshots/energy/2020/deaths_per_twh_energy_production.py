...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5198_deaths_per_twh_energy_production_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5198_deaths_per_twh_energy_production_config.json")
    snap_config.pull()
    ...
    meta.short_name = "deaths_per_twh_energy_production"
