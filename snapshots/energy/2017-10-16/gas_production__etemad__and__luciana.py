...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_972_gas_production__etemad__and__luciana_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_972_gas_production__etemad__and__luciana_config.json")
    snap_config.pull()
    ...
    meta.short_name = "gas_production__etemad__and__luciana"
