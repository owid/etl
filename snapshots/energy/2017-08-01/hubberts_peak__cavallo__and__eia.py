...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_651_hubberts_peak__cavallo__and__eia_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_651_hubberts_peak__cavallo__and__eia_config.json")
    snap_config.pull()
    ...
    meta.short_name = "hubberts_peak__cavallo__and__eia"
