...
def main(upload: bool) -> None:
    ...
    snap_config = Snapshot(
        "backport/latest/dataset_575_public_support_and_opposition_to_nuclear_energy__ipsos_mori__2011_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "public_support_and_opposition_to_nuclear_energy__ipsos_mori__2011"
