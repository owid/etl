...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5409_lead_petrol_banned_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5409_lead_petrol_banned_config.json")
    snap_config.pull()
    ...
    meta.short_name = "lead_petrol_banned"
