...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_5399_coal_phase_out__ppca__beyondcoal_and_other_sources_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_5399_coal_phase_out__ppca__beyondcoal_and_other_sources_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "coal_phase_out__ppca__beyondcoal_and_other_sources"
