...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_3179_number_of_people_with_and_without_energy_access__owid_based_on_world_bank__2021_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_3179_number_of_people_with_and_without_energy_access__owid_based_on_world_bank__2021_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "number_of_people_with_and_without_energy_access__owid_based_on_world_bank__2021"
