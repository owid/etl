...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_466_renewable_investment_as_pct_of_gdp__bnep_and_world_bank_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_466_renewable_investment_as_pct_of_gdp__bnep_and_world_bank_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "renewable_investment_as_pct_of_gdp__bnep_and_world_bank"
