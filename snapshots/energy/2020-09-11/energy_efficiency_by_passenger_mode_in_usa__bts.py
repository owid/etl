...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_5167_energy_efficiency_by_passenger_mode_in_usa__bts_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5167_energy_efficiency_by_passenger_mode_in_usa__bts_config.json")
    snap_config.pull()
    ...
    meta.short_name = "energy_efficiency_by_passenger_mode_in_usa__bts"
