...
def main(upload: bool) -> None:
    ...
    columns = ["country", "status", "enforcement_year", "comments", "evidence", "url"]
    data = [
        # Add countries where chick culling is fully or partially banned by law (or planned to be so).
        (
            "Austria",
            "Banned by law",
            2023,
        ...
        # Add countries for which there is evidence of chick culling with no ban enforced or planned.
        (
            "Australia",
            "No laws",
            np.nan,
