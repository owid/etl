...
def main(upload: bool) -> None:
    ...
    data = [
        ...
        (
            ...
            2027,
            "",
            "Congress of Colombia, Chamber of Representatives 219/2023C & Senate 309/2023S.",
            "https://www.camara.gov.co/prohibicion-corridas-de-toros",
            "",
        ),
        (
            "Costa Rica",
    ...
    snap.metadata.origin.citation_full = sources_text.strip()  # ty: ignore
