...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5225_deforestation_in_trade__pendrill_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5225_deforestation_in_trade__pendrill_config.json")
    snap_config.pull()
    ...
    meta.short_name = "deforestation_in_trade__pendrill"
