...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_2451_emissions_air_pollutants_over_long_term__defra__and__epa_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_2451_emissions_air_pollutants_over_long_term__defra__and__epa_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "emissions_air_pollutants_over_long_term__defra__and__epa"
