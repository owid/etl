...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_2672_emissions_intensity__and__value_added_by_sector__linus_et_al_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_2672_emissions_intensity__and__value_added_by_sector__linus_et_al_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "emissions_intensity__and__value_added_by_sector__linus_et_al"
