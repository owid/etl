...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_5319_eat_lancet_diet_composition__grams_per_capita_per_day_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_5319_eat_lancet_diet_composition__grams_per_capita_per_day_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "eat_lancet_diet_composition__grams_per_capita_per_day"
