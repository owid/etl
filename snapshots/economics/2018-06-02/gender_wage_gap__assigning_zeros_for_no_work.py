...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_2715_gender_wage_gap__assigning_zeros_for_no_work_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_2715_gender_wage_gap__assigning_zeros_for_no_work_config.json")
    snap_config.pull()
    ...
    meta.short_name = "gender_wage_gap__assigning_zeros_for_no_work"
