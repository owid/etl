...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_1016_eci_country_rankings__observatory_of_economic_complexity__2016__and_the_atlas_of_economic_complexity__2016_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_1016_eci_country_rankings__observatory_of_economic_complexity__2016__and_the_atlas_of_economic_complexity__2016_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = (
        "eci_country_rankings__observatory_of_economic_complexity__2016__and_the_atlas_of_economic_complexity__2016"
    )
