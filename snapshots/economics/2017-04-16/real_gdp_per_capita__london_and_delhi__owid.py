...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_520_real_gdp_per_capita__london_and_delhi__owid_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_520_real_gdp_per_capita__london_and_delhi__owid_config.json")
    snap_config.pull()
    ...
    meta.short_name = "real_gdp_per_capita__london_and_delhi__owid"
