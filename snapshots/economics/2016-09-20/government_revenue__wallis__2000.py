...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_296_government_revenue__wallis__2000_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_296_government_revenue__wallis__2000_config.json")
    snap_config.pull()
    ...
    meta.short_name = "government_revenue__wallis__2000"
