...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_4156_firms_with_financial_constraints__world_bank_enterprise_survey__2019_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_4156_firms_with_financial_constraints__world_bank_enterprise_survey__2019_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "firms_with_financial_constraints__world_bank_enterprise_survey__2019"
