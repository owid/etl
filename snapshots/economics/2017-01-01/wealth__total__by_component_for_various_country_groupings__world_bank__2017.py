...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_1034_wealth__total__by_component_for_various_country_groupings__world_bank__2017_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_1034_wealth__total__by_component_for_various_country_groupings__world_bank__2017_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "wealth__total__by_component_for_various_country_groupings__world_bank__2017"
