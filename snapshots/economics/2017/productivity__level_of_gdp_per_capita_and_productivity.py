...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_2553_productivity__level_of_gdp_per_capita_and_productivity_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_2553_productivity__level_of_gdp_per_capita_and_productivity_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "productivity__level_of_gdp_per_capita_and_productivity"
