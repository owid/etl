...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_303_top_marginal_income_tax_rate__reynolds__2008_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_303_top_marginal_income_tax_rate__reynolds__2008_config.json")
    snap_config.pull()
    ...
    meta.short_name = "top_marginal_income_tax_rate__reynolds__2008"
