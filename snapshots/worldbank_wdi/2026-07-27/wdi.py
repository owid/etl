...
- ⚠️ CHECK THAT GDP PER CAPITA IN CONSTANT PPPs HAS THE LATEST YEAR BEFORE SHIPPING.
  The World Bank backfills a release *in place* over several weeks without bumping
  `version_producer` or `last_updated_date`, and the PPP-denominated series lag the rest.
  In the July 2026 cycle, `NY.GDP.PCAP.PP.KD` / `NY.GDP.PCAP.PP.CD` had **zero** values for 2025
  at first release (2026-07-14) and still zero in a 2026-07-16 re-fetch, while the US$/LCU series
