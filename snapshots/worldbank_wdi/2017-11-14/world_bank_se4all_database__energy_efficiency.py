...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_1087_world_bank_se4all_database__energy_efficiency_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_1087_world_bank_se4all_database__energy_efficiency_config.json")
    snap_config.pull()
    ...
    meta.short_name = "world_bank_se4all_database__energy_efficiency"
