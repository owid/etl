...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_241_human_rights_protection__fariss_et_al__2020_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_241_human_rights_protection__fariss_et_al__2020_config.json")
    snap_config.pull()
    ...
    meta.short_name = "human_rights_protection__fariss_et_al__2020"
