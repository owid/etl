...
After creating the file, run
    python snapshots/chartbook/2024-08-20/soepmonitor_1984_1983_germany_gini.py --path-to-file <path-to-file>
"""
...
def main(path_to_file: str, upload: bool) -> None:
    ...
    snap = Snapshot(f"chartbook/{SNAPSHOT_VERSION}/soepmonitor_1984_1983_germany_gini.csv")
