...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_120_united_nations_peacekeeping_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_120_united_nations_peacekeeping_config.json")
    snap_config.pull()
    ...
    meta.short_name = "united_nations_peacekeeping"
