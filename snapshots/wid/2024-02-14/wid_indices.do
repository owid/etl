...
2. It generates four files, which exclude and include extrapolations. They need to be imported as snapshots in the ETL, as
	python snapshots/wid/2024-02-14/world_inequality_database.py --path-to-file snapshots/wid/2024-02-14/wid_indices_992j_exclude.csv
	python snapshots/wid/2024-02-14/world_inequality_database_with_extrapolations.py --path-to-file snapshots/wid/2024-02-14/wid_indices_992j_include.csv
	python snapshots/wid/2024-02-14/world_inequality_database_distribution.py --path-to-file snapshots/wid/2024-02-14/wid_distribution_992j_exclude.csv
	python snapshots/wid/2024-02-14/world_inequality_database_distribution_with_extrapolations.py --path-to-file snapshots/wid/2024-02-14/wid_distribution_992j_include.csv
