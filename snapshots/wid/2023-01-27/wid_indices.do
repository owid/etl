...
2. It generates two files, wid_indices_992j_exclude.csv and wid_indices_992j_include.csv, which exclude and include extrapolations. They need to be imported as snapshots in the ETL, as
	etls wid/2023-01-27/world_inequality_database --path-to-file snapshots/wid/2023-01-27/wid_indices_992j_exclude.csv
	etls wid/2023-01-27/world_inequality_database_with_extrapolations --path-to-file snapshots/wid/2023-01-27/wid_indices_992j_include.csv
