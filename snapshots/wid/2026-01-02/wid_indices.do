...
2. It generates four files, which exclude and include extrapolations. They need to be imported as snapshots in the ETL, as
	etls wid/2026-01-02/world_inequality_database --path-to-file snapshots/wid/2026-01-02/wid_indices_992j_exclude.csv
	etls wid/2026-01-02/world_inequality_database_with_extrapolations --path-to-file snapshots/wid/2026-01-02/wid_indices_992j_include.csv
	etls wid/2026-01-02/world_inequality_database_distribution --path-to-file snapshots/wid/2026-01-02/wid_distribution_992j_exclude.csv
	etls wid/2026-01-02/world_inequality_database_distribution_with_extrapolations --path-to-file snapshots/wid/2026-01-02/wid_distribution_992j_include.csv
	etls wid/2026-01-02/world_inequality_database_fiscal --path-to-file snapshots/wid/2026-01-02/wid_indices_fiscal_992ijt_exclude.csv
