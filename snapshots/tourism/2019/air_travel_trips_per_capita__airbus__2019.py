...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5193_air_travel_trips_per_capita__airbus__2019_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5193_air_travel_trips_per_capita__airbus__2019_config.json")
    snap_config.pull()
    ...
    meta.short_name = "air_travel_trips_per_capita__airbus__2019"
