...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_4118_world_press_freedom_index__reporters_sans_frontieres__2022_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_4118_world_press_freedom_index__reporters_sans_frontieres__2022_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "world_press_freedom_index__reporters_sans_frontieres__2022"
