...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_3199_te_16_18_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_3199_te_16_18_config.json")
    snap_config.pull()
