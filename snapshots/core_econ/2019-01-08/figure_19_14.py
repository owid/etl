...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_3176_figure_19_14_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_3176_figure_19_14_config.json")
    snap_config.pull()
