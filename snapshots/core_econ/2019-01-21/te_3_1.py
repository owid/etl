...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_3182_te_3_1_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_3182_te_3_1_config.json")
    snap_config.pull()
