...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5116_te_13_4_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5116_te_13_4_config.json")
    snap_config.pull()
