...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5115_figure_19_30c_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5115_figure_19_30c_config.json")
    snap_config.pull()
