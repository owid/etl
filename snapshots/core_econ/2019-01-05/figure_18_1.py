...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_3166_figure_18_1_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_3166_figure_18_1_config.json")
    snap_config.pull()
