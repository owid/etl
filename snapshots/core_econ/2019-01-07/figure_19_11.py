...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_3174_figure_19_11_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_3174_figure_19_11_config.json")
    snap_config.pull()
