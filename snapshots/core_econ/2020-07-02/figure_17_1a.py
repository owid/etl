...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5101_figure_17_1a_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5101_figure_17_1a_config.json")
    snap_config.pull()
