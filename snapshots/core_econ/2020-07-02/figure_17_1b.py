...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5103_figure_17_1b_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5103_figure_17_1b_config.json")
    snap_config.pull()
