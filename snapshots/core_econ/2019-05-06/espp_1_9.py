...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_4106_espp_1_9_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_4106_espp_1_9_config.json")
    snap_config.pull()
