...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5150_te_22_2_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5150_te_22_2_config.json")
    snap_config.pull()
