...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_3172_te_19_5_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_3172_te_19_5_config.json")
    snap_config.pull()
