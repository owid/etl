...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_3161_te_1_11_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_3161_te_1_11_config.json")
    snap_config.pull()
