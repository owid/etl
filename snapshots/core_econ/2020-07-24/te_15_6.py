...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5120_te_15_6_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5120_te_15_6_config.json")
    snap_config.pull()
