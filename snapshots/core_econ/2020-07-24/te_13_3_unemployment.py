...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5127_te_13_3_unemployment_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5127_te_13_3_unemployment_config.json")
    snap_config.pull()
    ...
    meta.short_name = "te_13_3_unemployment"
