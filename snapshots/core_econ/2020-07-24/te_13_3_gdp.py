...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5126_te_13_3_gdp_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5126_te_13_3_gdp_config.json")
    snap_config.pull()
