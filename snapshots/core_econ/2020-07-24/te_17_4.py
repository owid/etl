...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5121_te_17_4_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5121_te_17_4_config.json")
    snap_config.pull()
