...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5129_te_13_20a_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5129_te_13_20a_config.json")
    snap_config.pull()
