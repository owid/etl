...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5130_te_13_20b_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5130_te_13_20b_config.json")
    snap_config.pull()
