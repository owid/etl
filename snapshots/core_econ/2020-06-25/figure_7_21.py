...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5088_figure_7_21_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5088_figure_7_21_config.json")
    snap_config.pull()
