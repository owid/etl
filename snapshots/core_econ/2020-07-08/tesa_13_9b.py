...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5110_tesa_13_9b_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5110_tesa_13_9b_config.json")
    snap_config.pull()
