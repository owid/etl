...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5111_tesa_14_15_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5111_tesa_14_15_config.json")
    snap_config.pull()
