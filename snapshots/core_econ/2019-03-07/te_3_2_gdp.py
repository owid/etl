...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_3258_te_3_2_gdp_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_3258_te_3_2_gdp_config.json")
    snap_config.pull()
