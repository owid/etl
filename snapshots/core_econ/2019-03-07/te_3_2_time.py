...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_3259_te_3_2_time_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_3259_te_3_2_time_config.json")
    snap_config.pull()
