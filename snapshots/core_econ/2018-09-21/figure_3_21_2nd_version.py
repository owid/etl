...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_2973_figure_3_21_2nd_version_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_2973_figure_3_21_2nd_version_config.json")
    snap_config.pull()
    ...
    meta.short_name = "figure_3_21_2nd_version"
