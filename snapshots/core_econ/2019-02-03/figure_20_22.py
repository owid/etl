...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_3209_figure_20_22_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_3209_figure_20_22_config.json")
    snap_config.pull()
