...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_3206_te_20_19a_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_3206_te_20_19a_config.json")
    snap_config.pull()
