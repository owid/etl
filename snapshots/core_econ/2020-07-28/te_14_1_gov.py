...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5133_te_14_1_gov_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5133_te_14_1_gov_config.json")
    snap_config.pull()
