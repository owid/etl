...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5135_figure_16_3_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5135_figure_16_3_config.json")
    snap_config.pull()
