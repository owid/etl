...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5131_te_13_20c_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5131_te_13_20c_config.json")
    snap_config.pull()
