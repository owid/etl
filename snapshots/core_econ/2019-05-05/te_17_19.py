...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_4101_te_17_19_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_4101_te_17_19_config.json")
    snap_config.pull()
