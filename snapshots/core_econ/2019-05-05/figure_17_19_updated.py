...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_4100_figure_17_19_updated_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_4100_figure_17_19_updated_config.json")
    snap_config.pull()
    ...
    meta.short_name = "figure_17_19_updated"
