...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_4165_te_19_30a_2_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_4165_te_19_30a_2_config.json")
    snap_config.pull()
