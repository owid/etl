...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_3248_te_20_25b_env_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_3248_te_20_25b_env_config.json")
    snap_config.pull()
