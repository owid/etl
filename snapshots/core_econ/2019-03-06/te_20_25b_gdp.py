...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_3249_te_20_25b_gdp_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_3249_te_20_25b_gdp_config.json")
    snap_config.pull()
