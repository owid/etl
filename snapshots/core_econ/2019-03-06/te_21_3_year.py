...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_3250_te_21_3_year_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_3250_te_21_3_year_config.json")
    snap_config.pull()
