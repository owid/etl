...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_3246_te_20_25a_co2_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_3246_te_20_25a_co2_config.json")
    snap_config.pull()
