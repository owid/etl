...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_3247_te_20_25a_gdp_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_3247_te_20_25a_gdp_config.json")
    snap_config.pull()
