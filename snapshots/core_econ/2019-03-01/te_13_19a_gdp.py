...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_3229_te_13_19a_gdp_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_3229_te_13_19a_gdp_config.json")
    snap_config.pull()
