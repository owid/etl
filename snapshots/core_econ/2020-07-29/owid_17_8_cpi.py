...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5138_owid_17_8_cpi_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5138_owid_17_8_cpi_config.json")
    snap_config.pull()
