...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5140_te_17_13_gov_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5140_te_17_13_gov_config.json")
    snap_config.pull()
