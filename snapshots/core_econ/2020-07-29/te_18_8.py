...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5147_te_18_8_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5147_te_18_8_config.json")
    snap_config.pull()
