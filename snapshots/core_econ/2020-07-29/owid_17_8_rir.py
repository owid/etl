...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5137_owid_17_8_rir_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5137_owid_17_8_rir_config.json")
    snap_config.pull()
