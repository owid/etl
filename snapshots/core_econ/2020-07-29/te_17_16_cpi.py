...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5142_te_17_16_cpi_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5142_te_17_16_cpi_config.json")
    snap_config.pull()
