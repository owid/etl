...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5139_owid_17_8_unemp_gov_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5139_owid_17_8_unemp_gov_config.json")
    snap_config.pull()
    ...
    meta.short_name = "owid_17_8_unemp_gov"
