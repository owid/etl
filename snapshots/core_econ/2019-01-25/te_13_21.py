...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_3191_te_13_21_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_3191_te_13_21_config.json")
    snap_config.pull()
