...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_3194_te_15_13_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_3194_te_15_13_config.json")
    snap_config.pull()
