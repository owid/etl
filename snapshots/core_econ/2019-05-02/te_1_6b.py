...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_4097_te_1_6b_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_4097_te_1_6b_config.json")
    snap_config.pull()
