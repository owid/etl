...
- Download the Core dataset (Stata format). The name of the file should be similar to UNUWIDERGRD_{year}.dta_.zip
- Unzip the file and upload the Stata file (UNUWIDERGRD_{year}.dta) by running:
    etls unu_wider/{version}/government_revenue_dataset --path-to-file *path to Stata file*
