...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_852_drug_overdose_deaths_in_the_us__cdc_wonder_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_852_drug_overdose_deaths_in_the_us__cdc_wonder_config.json")
    snap_config.pull()
    ...
    meta.short_name = "drug_overdose_deaths_in_the_us__cdc_wonder"
