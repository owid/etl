...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_4881_ethnographic_and_archaeological_evidence_on_violent_deaths_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_4881_ethnographic_and_archaeological_evidence_on_violent_deaths_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "ethnographic_and_archaeological_evidence_on_violent_deaths"
