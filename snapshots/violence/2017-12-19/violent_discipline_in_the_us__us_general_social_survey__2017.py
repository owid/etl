...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_1889_violent_discipline_in_the_us__us_general_social_survey__2017_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_1889_violent_discipline_in_the_us__us_general_social_survey__2017_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "violent_discipline_in_the_us__us_general_social_survey__2017"
