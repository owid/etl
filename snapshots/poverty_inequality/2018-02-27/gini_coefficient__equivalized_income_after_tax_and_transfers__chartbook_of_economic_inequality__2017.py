...
def main(upload: bool) -> None:
    ...
    snap_config = Snapshot(
        "backport/latest/dataset_2482_gini_coefficient__equivalized_income_after_tax_and_transfers__chartbook_of_economic_inequality__2017_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = (
        "gini_coefficient__equivalized_income_after_tax_and_transfers__chartbook_of_economic_inequality__2017"
    )
