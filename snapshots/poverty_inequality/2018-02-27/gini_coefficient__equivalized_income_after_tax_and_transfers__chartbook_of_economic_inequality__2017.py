...
def main(upload: bool) -> None:
    ...
    snap = Snapshot("poverty_inequality/2018-02-27/gini_coefficient__equivalized_income_after_tax_and_transfers__chartbook_of_economic_inequality__2017.feather")
