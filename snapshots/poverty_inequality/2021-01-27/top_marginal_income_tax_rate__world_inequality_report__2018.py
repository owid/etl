...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_5246_top_marginal_income_tax_rate__world_inequality_report__2018_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_5246_top_marginal_income_tax_rate__world_inequality_report__2018_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "top_marginal_income_tax_rate__world_inequality_report__2018"
