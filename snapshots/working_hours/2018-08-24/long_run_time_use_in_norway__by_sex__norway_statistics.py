...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_2893_long_run_time_use_in_norway__by_sex__norway_statistics_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_2893_long_run_time_use_in_norway__by_sex__norway_statistics_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "long_run_time_use_in_norway__by_sex__norway_statistics"
