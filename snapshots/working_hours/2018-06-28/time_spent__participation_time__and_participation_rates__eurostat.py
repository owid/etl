...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_2826_time_spent__participation_time__and_participation_rates__eurostat_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_2826_time_spent__participation_time__and_participation_rates__eurostat_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "time_spent__participation_time__and_participation_rates__eurostat"
