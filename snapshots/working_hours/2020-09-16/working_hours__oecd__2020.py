...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5172_working_hours__oecd__2020_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5172_working_hours__oecd__2020_config.json")
    snap_config.pull()
    ...
    meta.short_name = "working_hours__oecd__2020"
