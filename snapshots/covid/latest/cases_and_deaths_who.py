...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5883_covid_19_cases_and_deaths__who_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5883_covid_19_cases_and_deaths__who_config.json")
    snap_config.pull()
    ...
    meta.short_name = "cases_and_deaths_who"
