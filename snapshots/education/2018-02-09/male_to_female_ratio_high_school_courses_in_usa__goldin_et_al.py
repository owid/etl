...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_2076_male_to_female_ratio_high_school_courses_in_usa__goldin_et_al_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_2076_male_to_female_ratio_high_school_courses_in_usa__goldin_et_al_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "male_to_female_ratio_high_school_courses_in_usa__goldin_et_al"
