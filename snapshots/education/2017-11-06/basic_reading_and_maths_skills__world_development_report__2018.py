...
def main(upload: bool) -> None:
    ...
    snap_config = Snapshot(
        "backport/latest/dataset_1018_basic_reading_and_maths_skills__world_development_report__2018_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "basic_reading_and_maths_skills__world_development_report__2018"
