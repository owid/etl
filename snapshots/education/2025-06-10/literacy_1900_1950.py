...
The workflow involved several manual and AI-assisted steps:
    1. Screenshot capture: Specific table data was located on pages 200 and 213 of the PDF, and screenshots of these pages were taken.
...
def run(path_to_file: str, upload: bool) -> None:
    ...
    snap = Snapshot(f"education/{SNAPSHOT_VERSION}/literacy_1900_1950.csv")
