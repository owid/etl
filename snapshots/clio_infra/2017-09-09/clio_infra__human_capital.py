...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_874_clio_infra__human_capital_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_874_clio_infra__human_capital_config.json")
    snap_config.pull()
    ...
    meta.short_name = "clio_infra__human_capital"
