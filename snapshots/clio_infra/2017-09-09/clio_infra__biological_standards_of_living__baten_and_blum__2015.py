...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_871_clio_infra__biological_standards_of_living__baten_and_blum__2015_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_871_clio_infra__biological_standards_of_living__baten_and_blum__2015_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "clio_infra__biological_standards_of_living__baten_and_blum__2015"
