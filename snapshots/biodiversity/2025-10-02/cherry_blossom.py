...
def create_table_for_recent_years() -> pd.DataFrame:
    ...
    This function manually adds data for the years 2016 to 2025. The data for 2016 to 2021 is sourced from the official dataset [website](http://atmenv.envi.osakafu-u.ac.jp/aono/kyophenotemp4/),
    while the data for 2022-2025 comes from personal communication with the dataset author. They also tweeted the data for 2024: https://x.com/aono_yasuyuki/status/1776512617886191808
    Returns:
