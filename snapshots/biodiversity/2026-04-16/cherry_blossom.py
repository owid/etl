...
def create_table_for_recent_years() -> pd.DataFrame:
    ...
    This function manually adds data for the years 2016 to 2026. The data for 2016 to 2021 is sourced from the official dataset from Prof. Aono's website (not available anymore).
