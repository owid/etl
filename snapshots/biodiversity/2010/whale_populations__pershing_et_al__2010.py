...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_4194_whale_populations__pershing_et_al__2010_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_4194_whale_populations__pershing_et_al__2010_config.json")
    snap_config.pull()
    ...
    meta.short_name = "whale_populations__pershing_et_al__2010"
