...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5327_uk_butterfly_populations__uk_ons_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5327_uk_butterfly_populations__uk_ons_config.json")
    snap_config.pull()
    ...
    meta.short_name = "uk_butterfly_populations__uk_ons"
