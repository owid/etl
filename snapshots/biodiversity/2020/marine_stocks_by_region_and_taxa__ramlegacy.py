...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5367_marine_stocks_by_region_and_taxa__ramlegacy_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5367_marine_stocks_by_region_and_taxa__ramlegacy_config.json")
    snap_config.pull()
    ...
    meta.short_name = "marine_stocks_by_region_and_taxa__ramlegacy"
