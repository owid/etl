...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_5311_biodiversity_habitat_loss__williams_et_al__2021_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5311_biodiversity_habitat_loss__williams_et_al__2021_config.json")
    snap_config.pull()
