...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5356_fish_discards__un_fao_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5356_fish_discards__un_fao_config.json")
    snap_config.pull()
    ...
    meta.short_name = "fish_discards__un_fao"
