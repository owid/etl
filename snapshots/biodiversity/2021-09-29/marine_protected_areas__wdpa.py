...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5388_marine_protected_areas__wdpa_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5388_marine_protected_areas__wdpa_config.json")
    snap_config.pull()
    ...
    meta.short_name = "marine_protected_areas__wdpa"
