...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5275_eu_wild_bird_populations__eurostat__2022_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5275_eu_wild_bird_populations__eurostat__2022_config.json")
    snap_config.pull()
    ...
    meta.short_name = "eu_wild_bird_populations__eurostat__2022"
