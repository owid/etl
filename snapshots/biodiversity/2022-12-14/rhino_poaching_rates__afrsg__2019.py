...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_4190_rhino_poaching_rates__afrsg__2019_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_4190_rhino_poaching_rates__afrsg__2019_config.json")
    snap_config.pull()
    ...
    meta.short_name = "rhino_poaching_rates__afrsg__2019"
