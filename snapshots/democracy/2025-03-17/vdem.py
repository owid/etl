...
- Go to "Country-Year: V-Dem Full+Others" page: https://www.v-dem.net/data/the-v-dem-dataset/country-year-v-dem-fullothers-v15/
- Fill the form (choose CSV) and download the ZIP file.
