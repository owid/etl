...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_276_trust__eurostat_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_276_trust__eurostat_config.json")
    snap_config.pull()
    ...
    meta.short_name = "trust__eurostat"
