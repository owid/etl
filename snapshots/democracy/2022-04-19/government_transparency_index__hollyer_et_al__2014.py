...
def main(upload: bool) -> None:
    ...
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_189_government_transparency_index__hollyer_et_al__2014_config.json")
    snap_config.pull()
    ...
    meta.short_name = "government_transparency_index__hollyer_et_al__2014"
