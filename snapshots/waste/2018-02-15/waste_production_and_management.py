...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_2430_waste_production_and_management_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_2430_waste_production_and_management_config.json")
    snap_config.pull()
    ...
    meta.short_name = "waste_production_and_management"
