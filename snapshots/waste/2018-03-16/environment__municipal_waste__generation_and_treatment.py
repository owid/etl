...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_2573_environment__municipal_waste__generation_and_treatment_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_2573_environment__municipal_waste__generation_and_treatment_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "environment__municipal_waste__generation_and_treatment"
