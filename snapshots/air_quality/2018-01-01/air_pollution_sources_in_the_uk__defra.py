...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_2496_air_pollution_sources_in_the_uk__defra_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_2496_air_pollution_sources_in_the_uk__defra_config.json")
    snap_config.pull()
    ...
    meta.short_name = "air_pollution_sources_in_the_uk__defra"
