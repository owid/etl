...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_204_health_insurance_coverage__us__us_current_population_survey__2014_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_204_health_insurance_coverage__us__us_current_population_survey__2014_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "health_insurance_coverage__us__us_current_population_survey__2014"
