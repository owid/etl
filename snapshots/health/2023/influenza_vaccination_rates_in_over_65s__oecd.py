...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5777_influenza_vaccination_rates_in_over_65s__oecd_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5777_influenza_vaccination_rates_in_over_65s__oecd_config.json")
    snap_config.pull()
    ...
    meta.short_name = "influenza_vaccination_rates_in_over_65s__oecd"
