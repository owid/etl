...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_917_year_of_smallpox_eradication_by_country__who__1988_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_917_year_of_smallpox_eradication_by_country__who__1988_config.json")
    snap_config.pull()
    ...
    meta.short_name = "year_of_smallpox_eradication_by_country__who__1988"
