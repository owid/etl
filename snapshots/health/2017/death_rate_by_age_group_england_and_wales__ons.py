...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_1934_death_rate_by_age_group_in_england_and_wales__ons_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_1934_death_rate_by_age_group_in_england_and_wales__ons_config.json")
    snap_config.pull()
    ...
    meta.short_name = "death_rate_by_age_group_england_and_wales__ons"
