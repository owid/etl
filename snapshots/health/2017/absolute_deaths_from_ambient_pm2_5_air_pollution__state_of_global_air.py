...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_380_absolute_deaths_from_ambient_pm2_5_air_pollution__state_of_global_air_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_380_absolute_deaths_from_ambient_pm2_5_air_pollution__state_of_global_air_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "absolute_deaths_from_ambient_pm2_5_air_pollution__state_of_global_air"
