...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_2791_smallpox_cases_by_country_1920_1977_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_2791_smallpox_cases_by_country_1920_1977_config.json")
    snap_config.pull()
    ...
    meta.short_name = "smallpox_cases_by_country_1920_1977"
