...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_385_health_coverage__ilo__2014_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_385_health_coverage__ilo__2014_config.json")
    snap_config.pull()
    ...
    meta.short_name = "health_coverage__ilo__2014"
