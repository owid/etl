...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5213_swedish_covid_19_deaths_comparison_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5213_swedish_covid_19_deaths_comparison_config.json")
    snap_config.pull()
    ...
    meta.short_name = "swedish_covid_19_deaths_comparison"
