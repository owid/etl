...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_4251_streptococcus_caused_deaths_in_children_under_5__wahl__2018_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_4251_streptococcus_caused_deaths_in_children_under_5__wahl__2018_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "streptococcus_caused_deaths_in_children_under_5__wahl__2018"
