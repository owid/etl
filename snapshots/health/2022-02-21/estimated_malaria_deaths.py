...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5528_estimated_malaria_deaths_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5528_estimated_malaria_deaths_config.json")
    snap_config.pull()
    ...
    meta.short_name = "estimated_malaria_deaths"
