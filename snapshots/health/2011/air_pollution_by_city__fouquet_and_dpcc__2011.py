...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_516_air_pollution_by_city__fouquet_and_dpcc__2011_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_516_air_pollution_by_city__fouquet_and_dpcc__2011_config.json")
    snap_config.pull()
    ...
    meta.short_name = "air_pollution_by_city__fouquet_and_dpcc__2011"
