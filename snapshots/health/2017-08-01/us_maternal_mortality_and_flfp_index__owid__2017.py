...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_846_us_maternal_mortality_and_flfp_index__owid__2017_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_846_us_maternal_mortality_and_flfp_index__owid__2017_config.json")
    snap_config.pull()
    ...
    meta.short_name = "us_maternal_mortality_and_flfp_index__owid__2017"
