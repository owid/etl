...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_4209_annual_deaths_averted_by_pcv13__chen_et_al__the_lancet_global_health__2019_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_4209_annual_deaths_averted_by_pcv13__chen_et_al__the_lancet_global_health__2019_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "annual_deaths_averted_by_pcv13__chen_et_al__the_lancet_global_health__2019"
