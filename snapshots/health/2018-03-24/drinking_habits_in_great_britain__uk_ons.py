...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_2700_drinking_habits_in_great_britain__uk_ons_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_2700_drinking_habits_in_great_britain__uk_ons_config.json")
    snap_config.pull()
    ...
    meta.short_name = "drinking_habits_in_great_britain__uk_ons"
