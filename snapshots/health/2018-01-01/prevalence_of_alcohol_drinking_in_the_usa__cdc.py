...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_2706_prevalence_of_alcohol_drinking_in_the_usa__cdc_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_2706_prevalence_of_alcohol_drinking_in_the_usa__cdc_config.json")
    snap_config.pull()
    ...
    meta.short_name = "prevalence_of_alcohol_drinking_in_the_usa__cdc"
