...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5439_lead_concentrations_in_paint__ipen__2021_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5439_lead_concentrations_in_paint__ipen__2021_config.json")
    snap_config.pull()
    ...
    meta.short_name = "lead_concentrations_in_paint__ipen__2021"
