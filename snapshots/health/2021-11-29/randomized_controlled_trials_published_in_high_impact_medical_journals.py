...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_5423_randomized_controlled_trials_published_in_high_impact_medical_journals_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_5423_randomized_controlled_trials_published_in_high_impact_medical_journals_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "randomized_controlled_trials_published_in_high_impact_medical_journals"
