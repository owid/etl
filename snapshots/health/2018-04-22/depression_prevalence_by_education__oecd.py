...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_2765_depression_prevalence_by_education__oecd_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_2765_depression_prevalence_by_education__oecd_config.json")
    snap_config.pull()
    ...
    meta.short_name = "depression_prevalence_by_education__oecd"
