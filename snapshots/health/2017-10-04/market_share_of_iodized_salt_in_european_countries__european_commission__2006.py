...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_950_market_share_of_iodized_salt_in_european_countries__european_commission__2006_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_950_market_share_of_iodized_salt_in_european_countries__european_commission__2006_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "market_share_of_iodized_salt_in_european_countries__european_commission__2006"
