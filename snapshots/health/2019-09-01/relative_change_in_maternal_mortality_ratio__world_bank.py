...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_4213_relative_change_in_maternal_mortality_ratio__world_bank_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_4213_relative_change_in_maternal_mortality_ratio__world_bank_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "relative_change_in_maternal_mortality_ratio__world_bank"
