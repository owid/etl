...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5781_seasonal_influenza_mortality__glamor__2019_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5781_seasonal_influenza_mortality__glamor__2019_config.json")
    snap_config.pull()
    ...
    meta.short_name = "seasonal_influenza_mortality__glamor__2019"
