...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_2763_mental_health_as_risk_factor_for_substance_use__swendsen_et_al__2010_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_2763_mental_health_as_risk_factor_for_substance_use__swendsen_et_al__2010_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "mental_health_as_risk_factor_for_substance_use__swendsen_et_al__2010"
