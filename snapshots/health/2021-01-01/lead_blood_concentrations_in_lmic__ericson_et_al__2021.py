...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_5411_lead_blood_concentrations_in_lmic__ericson_et_al__2021_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_5411_lead_blood_concentrations_in_lmic__ericson_et_al__2021_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "lead_blood_concentrations_in_lmic__ericson_et_al__2021"
