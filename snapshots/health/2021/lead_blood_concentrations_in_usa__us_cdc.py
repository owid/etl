...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5410_lead_blood_concentrations_in_usa__us_cdc_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5410_lead_blood_concentrations_in_usa__us_cdc_config.json")
    snap_config.pull()
    ...
    meta.short_name = "lead_blood_concentrations_in_usa__us_cdc"
