...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_2761_alcohol_consumption_in_usa_since_1850__niaaa_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_2761_alcohol_consumption_in_usa_since_1850__niaaa_config.json")
    snap_config.pull()
    ...
    meta.short_name = "alcohol_consumption_in_usa_since_1850__niaaa"
