...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5572_polio_vaccine_costs_in_low_income_countries_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5572_polio_vaccine_costs_in_low_income_countries_config.json")
    snap_config.pull()
    ...
    meta.short_name = "polio_vaccine_costs_in_low_income_countries"
