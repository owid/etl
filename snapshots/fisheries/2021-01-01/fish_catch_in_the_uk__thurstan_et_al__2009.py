...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5389_fish_catch_in_the_uk__thurstan_et_al__2009_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5389_fish_catch_in_the_uk__thurstan_et_al__2009_config.json")
    snap_config.pull()
    ...
    meta.short_name = "fish_catch_in_the_uk__thurstan_et_al__2009"
