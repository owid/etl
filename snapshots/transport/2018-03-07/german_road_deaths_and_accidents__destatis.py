...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_2497_german_road_deaths_and_accidents__destatis_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_2497_german_road_deaths_and_accidents__destatis_config.json")
    snap_config.pull()
    ...
    meta.short_name = "german_road_deaths_and_accidents__destatis"
