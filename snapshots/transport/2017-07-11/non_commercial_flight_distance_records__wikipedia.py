...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_567_non_commercial_flight_distance_records__wikipedia_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_567_non_commercial_flight_distance_records__wikipedia_config.json")
    snap_config.pull()
    ...
    meta.short_name = "non_commercial_flight_distance_records__wikipedia"
