...
def main(path_to_file: str, upload: bool) -> None:
    ...
    2. Select the following indicators:
        ...
        'Youth literacy rate, population 15-24 years, rural, adjusted gender parity index (GPIA)'
        'Youth literacy rate, population 15-24 years, male, adjusted location parity index (LPIA)'
        'Youth literacy rate, population 15-24 years, female, adjusted location parity index (LPIA)'
        ...
        'Literacy rate, population 25-64 years, female, adjusted location parity index (LPIA)'
        'Literacy rate, population 25-64 years, male, adjusted location parity index (LPIA)'
        'Literacy rate, population 25-64 years, rural, adjusted gender parity index (GPIA)'
        'Adult literacy rate, population 15+ years, male, adjusted location parity index (LPIA)'
        'Adult literacy rate, population 15+ years, female, adjusted location parity index (LPIA)'
        'Adult literacy rate, population 15+ years, adjusted location parity index (LPIA)'
        'Adult literacy rate, population 15+ years, adjusted gender parity index (GPIA)'
        'Elderly literacy rate, population 65+ years, male, adjusted location parity index (LPIA)'
        'Elderly literacy rate, population 65+ years, male (%)'
        'Elderly literacy rate, population 65+ years, female, adjusted location parity index (LPIA)'
    ...
    snap = Snapshot(f"worldbank_education/{SNAPSHOT_VERSION}/worldbank_literacy.csv")
