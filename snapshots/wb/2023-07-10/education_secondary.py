...
def main(path_to_file: str, upload: bool) -> None:
    ...
    2. Select the following indicators:
        ...
        'Out-of-school rate for adolescents and youth of lower and upper secondary school age, both sexes (%)'
        'Out-of-school rate for adolescents and youth of lower and upper secondary school age, adjusted gender parity index (GPIA)'
        'Out-of-school rate for adolescents and youth of lower and upper secondary school age, female (%)'
        'Out-of-school rate for adolescents and youth of lower and upper secondary school age, male (%)'
    ...
    snap = Snapshot(f"wb/{SNAPSHOT_VERSION}/education_secondary.csv")
