...
It uses 2021 prices from the World Bank's Poverty and Inequality Platform (PIP) data published in June 2025.

The file used here was provided by Nishant Yonzan via email on July 1, 2025, and it is not available online.
