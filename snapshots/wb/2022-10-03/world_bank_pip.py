...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_5689_world_bank_poverty_and_inequality_platform__pip_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5689_world_bank_poverty_and_inequality_platform__pip_config.json")
    snap_config.pull()
    ...
    meta.short_name = "world_bank_pip"
