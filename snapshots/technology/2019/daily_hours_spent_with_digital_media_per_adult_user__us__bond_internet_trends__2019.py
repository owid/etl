...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_4177_daily_hours_spent_with_digital_media_per_adult_user__us__bond_internet_trends__2019_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_4177_daily_hours_spent_with_digital_media_per_adult_user__us__bond_internet_trends__2019_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "daily_hours_spent_with_digital_media_per_adult_user__us__bond_internet_trends__2019"
