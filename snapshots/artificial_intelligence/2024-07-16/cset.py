...
This script reads, cleans, and combines the data from multiple CSV files on articles, patents and investment in AI and stores them into one csv file.
"""
...
def main(upload: bool, path_to_file: str) -> None:
    ...
    for field, file_ids in files.items():
        ...
        all_dfs.append(read_and_clean_data(file_ids, path_to_file + "/", field))
