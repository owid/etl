...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_5315_food_emissions_by_life_cycle_stage__poore_and_nemecek__2018_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_5315_food_emissions_by_life_cycle_stage__poore_and_nemecek__2018_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "food_emissions_by_life_cycle_stage__poore_and_nemecek__2018"
