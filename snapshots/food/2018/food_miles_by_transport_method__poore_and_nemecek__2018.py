...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_4879_food_miles_by_transport_method__poore__and__nemecek__2018_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_4879_food_miles_by_transport_method__poore__and__nemecek__2018_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "food_miles_by_transport_method__poore_and_nemecek__2018"
