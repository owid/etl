...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_649_coefficient_of_variation__cv__in_caloric_intake_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_649_coefficient_of_variation__cv__in_caloric_intake_config.json")
    snap_config.pull()
    ...
    meta.short_name = "coefficient_of_variation__cv__in_caloric_intake"
