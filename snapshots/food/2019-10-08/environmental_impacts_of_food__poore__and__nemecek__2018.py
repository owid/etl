...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_4223_environmental_impacts_of_food__poore__and__nemecek__2018_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_4223_environmental_impacts_of_food__poore__and__nemecek__2018_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "environmental_impacts_of_food__poore__and__nemecek__2018"
