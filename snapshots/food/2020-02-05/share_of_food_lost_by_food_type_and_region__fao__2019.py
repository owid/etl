...
def main(upload: bool) -> None:
    ...
    snap_config = Snapshot(
        "backport/latest/dataset_4913_share_of_food_lost_by_food_type_and_region__fao__2019_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "share_of_food_lost_by_food_type_and_region__fao__2019"
