...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_5060_calories_lost_by_food_group_and_region__wri__2013_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5060_calories_lost_by_food_group_and_region__wri__2013_config.json")
    snap_config.pull()
    ...
    meta.short_name = "calories_lost_by_food_group_and_region__wri__2013"
