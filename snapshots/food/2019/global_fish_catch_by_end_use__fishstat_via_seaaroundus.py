...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_5355_global_fish_catch_by_end_use__fishstat_via_seaaroundus_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_5355_global_fish_catch_by_end_use__fishstat_via_seaaroundus_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "global_fish_catch_by_end_use__fishstat_via_seaaroundus"
