"""Script to create a snapshot of the Integrated Values Surveys dataset.

This dataset contains selected questions of IVS, depending on our needs.
...
def main(path_to_file: str, upload: bool) -> None:
    ...
    snap = Snapshot(f"ivs/{SNAPSHOT_VERSION}/integrated_values_surveys.csv")
