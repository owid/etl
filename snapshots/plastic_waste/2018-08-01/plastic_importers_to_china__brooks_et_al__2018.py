...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_2850_plastic_importers_to_china__brooks_et_al__2018_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_2850_plastic_importers_to_china__brooks_et_al__2018_config.json")
    snap_config.pull()
    ...
    meta.short_name = "plastic_importers_to_china__brooks_et_al__2018"
