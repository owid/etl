...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_2854_decomposition_times_of_marine_debris_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_2854_decomposition_times_of_marine_debris_config.json")
    snap_config.pull()
    ...
    meta.short_name = "decomposition_times_of_marine_debris"
