...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5760_ocean_waste_items_by_region_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5760_ocean_waste_items_by_region_config.json")
    snap_config.pull()
    ...
    meta.short_name = "ocean_waste_items_by_region"
