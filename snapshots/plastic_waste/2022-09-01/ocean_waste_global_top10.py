...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5761_ocean_waste_global_top10_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5761_ocean_waste_global_top10_config.json")
    snap_config.pull()
    ...
    meta.short_name = "ocean_waste_global_top10"
