...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5759_ocean_waste_by_item_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5759_ocean_waste_by_item_config.json")
    snap_config.pull()
    ...
    meta.short_name = "ocean_waste_by_item"
