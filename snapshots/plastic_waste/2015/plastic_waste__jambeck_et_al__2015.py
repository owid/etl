...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_1831_plastic_waste__jambeck_et_al__2015_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_1831_plastic_waste__jambeck_et_al__2015_config.json")
    snap_config.pull()
    ...
    meta.short_name = "plastic_waste__jambeck_et_al__2015"
