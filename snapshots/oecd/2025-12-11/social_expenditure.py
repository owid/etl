...
STEPS TO OBTAIN THE DATA:
    ...
    4. Select these filters:
        ...
        4. Expenditure source: select all the options available.
        5. Spending type: select all the options available.
        6. Programme type: select all the options available.
    ...
    8. Run the script with the `--path-to-file` option:
        ```
        etls oecd/{version}/social_expenditure --path-to-file <path_to_file>
        ```
