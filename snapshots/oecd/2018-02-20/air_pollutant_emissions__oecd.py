...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_2457_air_pollutant_emissions__oecd_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_2457_air_pollutant_emissions__oecd_config.json")
    snap_config.pull()
    ...
    meta.short_name = "air_pollutant_emissions__oecd"
