...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_283_oecd__trust_in_government_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_283_oecd__trust_in_government_config.json")
    snap_config.pull()
    ...
    meta.short_name = "oecd__trust_in_government"
