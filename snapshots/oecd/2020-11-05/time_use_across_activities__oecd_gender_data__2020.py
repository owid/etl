...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot(
        "backport/latest/dataset_2724_time_use_across_activities__oecd_gender_data__2020_values.feather"
    )
    snap_values.pull()
    snap_config = Snapshot(
        "backport/latest/dataset_2724_time_use_across_activities__oecd_gender_data__2020_config.json"
    )
    snap_config.pull()
    ...
    meta.short_name = "time_use_across_activities__oecd_gender_data__2020"
