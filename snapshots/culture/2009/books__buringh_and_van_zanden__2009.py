...
def main(upload: bool) -> None:
    ...
    snap_values = Snapshot("backport/latest/dataset_5350_books__buringh_and_van_zanden__2009_values.feather")
    snap_values.pull()
    snap_config = Snapshot("backport/latest/dataset_5350_books__buringh_and_van_zanden__2009_config.json")
    snap_config.pull()
    ...
    meta.short_name = "books__buringh_and_van_zanden__2009"
