...
And checking the notifications (clicking on the bell sign on the top right corner).
Although they have many notifications, and it's not clear which one corresponds to a major update.
I will use the latest update, which signals that that's the last time they revisited (at least some of) their data.
