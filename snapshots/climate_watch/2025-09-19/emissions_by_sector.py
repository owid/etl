...
NOTE: The publication date can be found by going to
https://www.climatewatchdata.org/data-explorer/historical-emissions
Clicking on the "Sources & Metadata" tab, and checking "Frequency_of_updates".
    For example, as of 2025-09-19, it says "Frequency_of_updates: Annual. Last updated September 2025."
Additionally, checking the notifications (clicking on the bell sign on the top right corner), although they have many notifications, and it's not clear which one corresponds to a major update.
