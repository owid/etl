...
A **Claude desktop app** (claude.ai) variant of this skill is generated by
[desktop/build_bundle.py](desktop/README.md) — after substantive edits here, rebuild and re-share
the bundle (see that README). The build fails loudly when an edit moves one of its transform anchors.
