...
>
> Groups combine, so the whole pass is **three calls**: `--rows annotations` (34,014), `--rows
> type,geometry` (36,649), `--rows series,skipped` (34,618) — measured 2026-09-01, largest **73% of
