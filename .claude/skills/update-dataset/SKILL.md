...
- [ ] Empty-entity audit after all remaps: run the `check-empty-entities` skill (charts, map `columnSlug`, MDim views, narrative charts, gdoc `country=` references); regressions vs production = fix, pre-existing = document (see step 7)
