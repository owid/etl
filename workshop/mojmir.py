...
Run the app:
- To run this app, run: `streamlit run --server.port 20007 workshop/mojmir.py.
- Go to localhost:20007 (you might need to use port-forwarding)
"""
