...
Run the app:
- To run this app, run: `streamlit run --server.port 20009 workshop/sophia.py`.
- Go to localhost:20009 (you might need to use port-forwarding)
"""
