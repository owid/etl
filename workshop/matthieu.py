...
Hi Matthieu! How are you doing :3?
...
Run the app:
- To run this app, run: `streamlit run --server.port 20006 workshop/matthieu.py`.
- Go to localhost:20006 (you might need to use port-forwarding)
"""
