...
Run the app:
- To run this app, run: `streamlit run --server.port 20004 workshop/marcel.py`.
- Go to localhost:20004 (you might need to use port-forwarding)
"""
