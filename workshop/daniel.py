...
Run the app:
- To run this app, run: `streamlit run --server.port 20001 workshop/daniel.py`.
- Go to localhost:20001 (you might need to use port-forwarding)
"""
