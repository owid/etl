...
def run() -> None:
    ...
    tb_cpi["comp_performance_per_dollar"] = (
        tb_cpi["fp32__single_precision__performance__flop_s"] / tb_cpi["release_price__usd"]
    )
    ...
    ds_garden = paths.create_dataset(tables=[tb_cpi], default_metadata=ds_meadow.metadata)
