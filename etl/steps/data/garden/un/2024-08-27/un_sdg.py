...
def get_attributes_description() -> Dict:
    units_snapshot = paths.load_dataset(short_name="un_sdg_unit.csv", namespace="un")
...
def get_dimension_description() -> dict[str, str]:
    dimensions_snapshot = paths.load_dataset(short_name="un_sdg_dimension.json", namespace="un")
