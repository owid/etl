...
EMBER_DATASET_PATH = DATA_DIR / "garden/ember/2022-12-13/combined_electricity"
...
def prepare_output_table(combined: pd.DataFrame) -> catalog.Table:
    ...
    ----------
    combined : pd.DataFrame
        BP's Statistical Review combined with Ember's Combined Electricity, after adding per capita variables and
        share variables.
