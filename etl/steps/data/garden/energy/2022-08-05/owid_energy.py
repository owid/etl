...
def combine_tables_data_and_metadata(tables: Dict[str, catalog.Table],
                                     countries_regions: catalog.Table,
                                     variable_mapping: pd.DataFrame) -> catalog.Table:
...
def run(dest_dir: str) -> None:
    ...
    countries_regions = catalog.Dataset(DATA_DIR / "garden/reference/")["countries_regions"].\
    ...
    tables = {
        ...
        "primary_energy_consumption": tb_primary_energy.drop(columns=["population", "source"], errors="ignore"),
