...
def add_share_variables(combined: Table) -> Table:
    ...
    * Total net electricity imports as a share of total electricity demand.
    ...
    # Share of primary energy that is generated as electricity. Primary energy is total energy supply, the same
    # quantity we report as primary energy everywhere else, so the electricity generated by a nuclear or a fossil
    # plant is compared against the energy that went into it.
