...
COMMODITY_MAPPING = {
    ...
    ("Arsenic", "Plant production, arsenic trioxide or calculated equivalent."): ("Arsenic", "Plant"),
    ("Arsenic", "arsenic trioxide"): ("Arsenic", "Plant"),
    ...
    ("Boron", "Mine production, borates"): ("Boron", "Mine, borates"),
    ("Boron", "Mine production, boric oxide equivalent"): ("Boron", "Mine, boric oxide equivalent"),
    ("Boron", "Mine production, crude borates"): ("Boron", "Mine, crude borates"),
    ("Boron", "Mine production, crude ore"): ("Boron", "Mine, crude ore"),
    ("Boron", "Mine production, datolite ore"): ("Boron", "Mine, datolite ore"),
    ("Boron", "Mine production, ulexite"): ("Boron", "Mine, ulexite"),
    ("Boron", "Plant production, compounds"): ("Boron", "Plant, boron compounds"),
    ("Boron", "Plant production, refined borates"): ("Boron", "Plant, refined borates"),
    ("Boron", "borates"): ("Boron", "Mine, borates"),
    ("Boron", "boric oxide eqivalent"): ("Boron", "Mine, boric oxide equivalent"),
    ("Boron", "boric oxide equivalent"): ("Boron", "Mine, boric oxide equivalent"),
    ("Boron", "boron compounds"): ("Boron", "Plant, boron compounds"),
    ("Boron", "boron, crude ore"): ("Boron", "Mine, crude ore"),
    ("Boron", "compounds"): ("Boron", "Plant, boron compounds"),
    ("Boron", "crude borates"): ("Boron", "Mine, crude borates"),
    ("Boron", "crude ore"): ("Boron", "Mine, crude ore"),
    ("Boron", "datolite ore"): ("Boron", "Mine, datolite ore"),
    ("Boron", "refined borates"): ("Boron", "Plant, refined borates"),
    ("Boron", "ulexite"): ("Boron", "Mine, ulexite"),
    ("Bromine", "Plant production, bromine content"): ("Bromine", "Plant"),
    ("Bromine", "Production, bromine content"): ("Bromine", "Plant"),
    ("Bromine", "Production, bromine content, excluding U.S. production"): ("Bromine", "Plant"),
    ("Bromine", "Production"): ("Bromine", "Plant"),
    ...
    ("Chromium", "Mine production, marketable chromite ore"): ("Chromium", "Mine, marketable chromite ore"),
    ("Chromium", "Mne production, grosss weight, marketable chromite ore"): (
        "Chromium",
        "Mine, marketable chromite ore",
    ),
    ...
    ("Lime", "Plant production"): ("Lime", "Plant"),
    ("Lime", "Plant production, lime"): ("Lime", "Plant"),
...
UNITS_MAPPING = {
    ...
    "production|Chromium|Mine, marketable chromite ore|tonnes": "tonnes of gross weight",
    "reserves|Chromium|Mine, marketable chromite ore|tonnes": "tonnes of gross weight",
