...
VARIANTS_DETAILS = {
    ...
    "24D (Omicron)": {"rename": "Omicron (KP.2)", "relevant": True},
    "24E (Omicron)": {"rename": "Omicron (LB.1)", "relevant": True},
    "24F (Omicron)": {"rename": "Omicron (KP.3.1.1)", "relevant": True},
    "24G (Omicron)": {"rename": "Omicron (KP.2.3)", "relevant": True},
    "24H (Omicron)": {"rename": "Omicron (KP.1.1)", "relevant": True},
    "24I (Omicron)": {"rename": "Omicron (XEC)", "relevant": True},
    "25A (Omicron)": {"rename": "Omicron (XDV)", "relevant": True},
