...
def run() -> None:
    ...
    # Process data.
    #
    tb_hot = paths.regions.harmonize_names(tb=tb_hot, warn_on_unused_countries=False)
    tb_cme = paths.regions.harmonize_names(tb=tb_cme, warn_on_unused_countries=False)
