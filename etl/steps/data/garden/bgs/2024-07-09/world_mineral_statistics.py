...
COMMODITY_MAPPING = {
    ...
    ("Tantalum and niobium", "Pyrochlore"): ("Niobium", "Pyrochlore"),
    ...
    ("Tantalum and niobium minerals", "Pyrochlore"): ("Niobium", "Pyrochlore"),
    ...
    ("Titanium minerals", "Ilmenite"): ("Titanium", "Ilmenite"),
