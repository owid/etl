...
COMMODITY_MAPPING = {
    ...
    ("Aggregates, primary", "Total"): ("Primary aggregates", "Total"),
    ("Alumina", "Total"): ("Alumina", "Total"),
    ("Aluminium, primary", "Total"): ("Aluminum", "Primary"),
    ...
    ("Arsenic, white", "Total"): ("Arsenic", "White arsenic"),
    ...
    ("Bismuth, mine", "Total"): ("Bismuth", "Mine production"),
    ...
    ("Chromium ores and concentrates", "Total"): ("Chromium", "Ores & concentrates"),
    ...
    ("Cobalt, mine", "Total"): ("Cobalt", "Mine production"),
    ("Cobalt, refined", "Total"): ("Cobalt", "Refinery production"),
    ...
    ("Gallium, primary", "Total"): ("Gallium", "Primary"),
    ("Gemstones", "Total"): ("Gemstones", "Total"),
    ("Germanium metal", "Total"): ("Germanium", "Metal"),
    ...
    ("Gold, mine", "Total"): ("Gold", "Mine production"),
    ...
    ("Lead, mine", "Total"): ("Lead", "Mine production"),
    ...
    ("Magnesium metal, primary", "Total"): ("Magnesium metal", "Primary"),
    ...
    ("Molybdenum, mine", "Total"): ("Molybdenum", "Mine production"),
    ...
    ("Nickel, mine", "Total"): ("Nickel", "Mine production"),
