...
def extract_year_ranges(years_ranges):
    ...
    # Examples: "1964-66,72-75,80-", "1980-", "1953-62,82-87", "1970-2003", "1975-90", "2002-07", "2018-".
    years = []
    for years_range in years_ranges.split(","):
        if "-" in years_range:
            start, end = years_range.split("-")
            # Handle open-ended ranges like "2018-" by keeping only the start year.
            # The backfill block in run() extends the dataframe to year_last regardless.
            if end == "":
