...
# With stable GED 26.1 (data through 2025) + CED 2026-Q2, there are 1314 events without
# an exact polygon coordinate match (up from 1303 with CED 2026-Q1).
NUM_MISSING_LOCATIONS = 1314
