...
def run() -> None:
    ...
    tb_prio = tb_prio.loc[tb_prio["year"] < YEAR_UCDP_MIN]
    ...
    ds_garden = paths.create_dataset(
        ...
        default_metadata=ds_ucdp.metadata,
    )
...
def make_tb_country(tb_ucdp_countries: Table, tb_prio_countries: Table) -> Table:
    ...
    tb_prio_countries = tb_prio_countries.loc[tb_prio_countries["year"] < YEAR_UCDP_MIN]
    ...
    tb_extra = tb_ucdp_countries.loc[tb_ucdp_countries["conflict_type"] == "interstate"]
