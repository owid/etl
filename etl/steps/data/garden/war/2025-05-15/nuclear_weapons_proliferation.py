...
def run() -> None:
    ...
    tb = ds_bleek.read("spread_of_nuclear_weapons")
    ...
    tb_nti = ds_nti.read("nuclear_threat_initiative_overview")
    ...
    # Set an appropriate index and sort conveniently.
    tb_counts = tb_counts.format(["year"], sort_columns=True, short_name="nuclear_weapons_proliferation_counts")

    #
    # Save outputs.
    #
    # Create a new garden dataset.
    ds_garden = paths.create_dataset(tables=[tb, tb_counts])
    ds_garden.save()
