...
def run() -> None:
    ...
    tb_members = ds_members.read("un_members")
    ...
    tb_counts = tb_counts.format(["year", "status"], short_name="nuclear_weapons_treaties_country_counts")

    #
    # Save outputs.
    #
    # Create a new garden dataset.
    ds_garden = paths.create_dataset(tables=[tb, tb_counts], default_metadata=ds_meadow.metadata)
    ds_garden.save()
