# NOTE: Update lines in abs_dict if PPPs are updated
"""
...
var_dict = {
    ...
    "spl": {
        "title": "Societal poverty line",
        "description": "The Societal Poverty Line (SPL) is defined to account for national definitions of poverty around the world. The SPL is the International Poverty Line when the national median is sufficiently low and it grows as the median income grows.",
        "unit": "international-$ in {ppp} prices",
        "short_unit": "$",
        "numDecimalPlaces": 2,
    },
    ...
    "top1_share": {
        "title": "Top 1% - Share",
        "description": "The share of {inc_cons_dict[wel]['name_distribution']} {inc_cons_dict[wel]['verb']} by the richest 1%.",
        "unit": "%",
        "short_unit": "%",
        "numDecimalPlaces": 1,
    },
    "top90_99_share": {
        "title": "Between 90th and 99th percentiles - Share",
        "description": "The share of {inc_cons_dict[wel]['name_distribution']} {inc_cons_dict[wel]['verb']} by the population between the 90th and 99th percentiles.",
        "unit": "%",
        "short_unit": "%",
        "numDecimalPlaces": 1,
    },
    "top1_thr": {
        "title": "Top 1% - Threshold",
        "description": "The level of {inc_cons_dict[wel]['name_distribution']} per day below which 99% of the population falls.",
        "unit": "international-$ in {ppp} prices",
        "short_unit": "$",
        "numDecimalPlaces": 2,
    },
    "top1_avg": {
        "title": "Top 1% - Average",
        "description": "The mean {inc_cons_dict[wel]['name_distribution']} per day within the richest 1% of the population.",
        "unit": "international-$ in {ppp} prices",
        "short_unit": "$",
        "numDecimalPlaces": 2,
    },
...
inc_cons_dict = {
    ...
    "income_consumption": {
        ...
        "processing_description": """For most countries in the PIP dataset, estimates relate to _either_ disposable income or consumption, for all available years. A number of countries, however, have a mix of income and consumption data points, with both data types sometimes available for particular years.
...
abs_dict = {
    ...
    2021: {
        ...
        300: {
            "title": "$3 a day",
            "title_between": "$3",
            "description_key": "Extreme poverty here is defined as living below the International Poverty Line of $3 per day.",
        },
        420: {
            "title": "$4.20 a day",
            "title_between": "$4.20",
            "description_key": "A poverty line of $4.20 a day represents definitions of national poverty lines in lower-middle-income countries.",
        },
        830: {
            "title": "$8.30 a day",
            "title_between": "$8.30",
...
def var_metadata_inequality_mean_median(var, origins, welfare_type) -> VariableMeta:
    ...
    if var in ["mean", "median"]:
        ...
        meta = VariableMeta(
            ...
            description_processing=f"""{processing_description_share_90_99}
