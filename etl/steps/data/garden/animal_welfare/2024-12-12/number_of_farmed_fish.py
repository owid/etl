...
def run(dest_dir: str) -> None:
    ...
    tb = ds_meadow.read("number_of_farmed_fish_until_2017")

    ####################################################################################################################
    # TODO: Add data for after 2020, and consider adding 1990-2019 data from Mood et al. (2023)
    ####################################################################################################################
    ...
    # Add region aggregates.
    tb = add_region_aggregates(tb, ds_regions=ds_regions, ds_income_groups=ds_income_groups)
