...
def add_per_capita_variables(tb: Table, ds_population: Dataset) -> Table:
    ...
    tb["n_farmed_decapod_crustaceans_low_per_capita"] = tb["n_farmed_decapod_crustaceans_low"] / tb["population"]
    tb["n_farmed_decapod_crustaceans_per_capita"] = tb["n_farmed_decapod_crustaceans"] / tb["population"]
    tb["n_farmed_decapod_crustaceans_high_per_capita"] = tb["n_farmed_decapod_crustaceans_high"] / tb["population"]
...
def run(dest_dir: str) -> None:
    ...
    ds_meadow = paths.load_dataset("number_of_farmed_decapod_crustaceans")
