...
PROCESSING_DESCRIPTION = """Estimations of Gini, mean, percentile thresholds, averages, shares and the transparency index are extracted via the [`wid` Stata command](https://github.com/thomasblanchet/wid-stata-tool). Threshold and share ratios are calculated by dividing different thresholds and shares, respectively."""
