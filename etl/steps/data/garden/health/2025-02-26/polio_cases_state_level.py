...
def run(dest_dir: str) -> None:
    ...
    #
    # Load meadow dataset.
    ds_meadow = paths.load_dataset("polio_cases_state_level")
    ds_us_pop = paths.load_dataset("us_state_population")
    # Read table from meadow dataset.
    tb = ds_meadow.read("polio_cases_state_level")
    ...
    tb = tb.format(["country", "year"], short_name="polio_cases_state_level")
    # Save outputs.
    #
