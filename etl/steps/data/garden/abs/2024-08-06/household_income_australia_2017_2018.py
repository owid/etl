...
def run(dest_dir: str) -> None:
    ...
    #
    # Load meadow dataset.
    ds_meadow = paths.load_dataset("household_income_australia_2017_2018")

    # Read table from meadow dataset.
    tb = ds_meadow["household_income_australia_2017_2018"].reset_index()
    ...
    for country in list(tb["country"].unique()):
        tb.loc[tb["country"] == country, "spell_number"] = tb.loc[tb["country"] == country, "spell"].factorize()[0] + 1
