...
def run(dest_dir: str) -> None:
    ...
    for column in df_pivot.columns:
        ...
        df_pivot[column].metadata.description_from_producer = tb[
            "temperature_anomaly"
        ].metadata.description_from_producer
        df_pivot[column].metadata.description_processing = tb["temperature_anomaly"].metadata.description_processing
