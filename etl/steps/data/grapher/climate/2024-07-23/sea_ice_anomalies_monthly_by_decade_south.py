...
def create_yearly_table(tb: Table) -> Table:
    ...
    tb_yearly = tb_yearly.drop(columns=["decade", "location"], errors="raise").rename(
...
def create_decadal_table(tb: Table) -> Table:
    ...
    tb_decadal = tb_decadal.drop(columns=["location"], errors="raise").rename(
        columns={"decade": "country", "month": "year"}, errors="raise"
    )
