...
def run(dest_dir: str) -> None:
    ...
    tb_yearly = ds_garden["natural_disasters_yearly_deaths"]
    tb_decadal = ds_garden["natural_disasters_decadal_deaths"]
    ...
    ds_grapher.metadata.title = "Natural disasters by deaths"
    ds_grapher.save()
