...
@click.option(
    "--input-file",
    "-i",
    default="etl/steps/data/grapher/un/2026-07-31/un_sdg.sources_additional.json",
    help="Input JSON file with indicator IDs",
)
@click.option(
    "--output-file",
    "-o",
    default="etl/steps/data/grapher/un/2026-07-31/un_sdg.custodian_agencies.json",
