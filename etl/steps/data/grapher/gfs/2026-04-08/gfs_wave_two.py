...
def run() -> None:
    ...
    #
    # Load garden dataset
    ds_garden = paths.load_dataset("gfs_wave_two")

    # Read table from garden dataset.
    tb = ds_garden["gfs_wave_two"]
    ...
    ds_grapher = paths.create_dataset(
        tables=[tb_res], check_variables_metadata=True, default_metadata=ds_garden.metadata
    )

    # Update metadata of the new table.
    tb_res = ds_grapher["gfs_wave_two"]
