...
def run(dest_dir: str) -> None:
    log.info("gbd_risk.start")

    # retrieve raw data from walden
    walden_ds = WaldenCatalog().find_one(namespace="ihme_gbd", short_name="gbd_risk", version="2019")
    ...
    tb.update_metadata_from_yaml(N.metadata_path, "gbd_risk")
