...
def run() -> None:
    ...
    with snap.extracted() as archive:
        national_df = archive.read("SDG_DATA_NATIONAL.csv", low_memory=False)
        regional_df = archive.read("SDG_DATA_REGIONAL.csv", low_memory=False)
        label_df = archive.read("SDG_LABEL.csv", low_memory=False)
