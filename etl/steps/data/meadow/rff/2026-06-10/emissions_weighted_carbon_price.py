...
DATA_PATH_ECONOMY_GLOB = "ECP_v2026.2/ecp/ipcc/ecp_economy/ecp_vw/ecp_tv_CO2_*.csv"

# Path glob for the coverage data file. The filename also carries a build-date suffix.
DATA_PATH_COVERAGE_GLOB = "ECP_v2026.2/coverage/jurisdictions/tot_coverage_jurisdiction_CO2_*.csv"
