...
def prepare_solar_pv_module_prices(data_file: str) -> pd.DataFrame:
...
def run(dest_dir: str) -> None:
    ...
    solar_pv_prices = prepare_solar_pv_module_prices(data_file=local_file)
