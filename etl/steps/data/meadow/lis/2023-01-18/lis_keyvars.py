"""
Load the snapshot for 'Luxembourg Income Study - Key variables' and creates a meadow dataset.
...
def run(dest_dir: str) -> None:
    ...
    # Retrieve snapshot.
    snap: Snapshot = paths.load_dependency("lis_keyvars.csv")

    # Load data from snapshot.
    df = pd.read_csv(snap.path)

    # Define column types
    id_cols = ["country", "year", "dataset", "variable", "eq"]
