"""
Load the snapshot for 'Luxembourg Income Study - Distributional variables' and creates a meadow dataset.
...
def run(dest_dir: str) -> None:
    log.info("lis_distribution.start")
    ...
    # Retrieve snapshot.
    snap: Snapshot = paths.load_dependency("lis_distribution.csv")

    # Load data from snapshot.
    df = pd.read_csv(snap.path)

    # Define column types
    id_cols = ["country", "year", "dataset", "variable", "eq", "percentile"]
