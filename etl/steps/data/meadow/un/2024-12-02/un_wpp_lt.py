...
def run(dest_dir: str) -> None:
    ...
    for snap_short_name in snap_short_names:
        ...
        snap = paths.load_snapshot(f"{snap_short_name}.csv")
        tb = snap.read_csv(
            dtype={
                "Notes": str,
                "ISO3_code": "category",
    ...
    ds_meadow = create_dataset(dest_dir, tables=tables, check_variables_metadata=True, default_metadata=snap.metadata)  # ty: ignore
