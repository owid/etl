...
PROGRAMME_TYPE_CODES = {
    ...
    "TP521": {"new_name": "Early childhood education and care", "category": "Family"},
    "TP522": {"new_name": "Home help and accommodation", "category": "Family"},
    "TP523": {"new_name": "Other benefits in kind", "category": "Family"},
    "TP60": {"new_name": "Total", "category": "Active labor market"},
    "TP601": {"new_name": "Public employment services and administration", "category": "Active labor market"},
    "TP602": {"new_name": "Training", "category": "Active labor market"},
    "TP603": {"new_name": "Job rotation and job sharing", "category": "Active labor market"},
    "TP604": {"new_name": "Employment incentives", "category": "Active labor market"},
    "TP605": {"new_name": "Supported employment and rehabilitation", "category": "Active labor market"},
    "TP606": {"new_name": "Direct job creation", "category": "Active labor market"},
    "TP607": {"new_name": "Start-up incentives", "category": "Active labor market"},
    ...
    "TP91": {"new_name": "Total", "category": "Other social policy"},
    "TP911": {"new_name": "Income maintenance", "category": "Other social policy"},
    "TP912": {"new_name": "Other cash benefits", "category": "Other social policy"},
    "TP921": {"new_name": "Social assistance", "category": "Other social policy"},
    "TP922": {"new_name": "Other benefits in kind", "category": "Other social policy"},
}
