...
def run() -> None:
    ...
    # Before 1951 BEIS only reports major power producers; the all-generators series start in 1951.
    tb_efficiency = prepare_data(
        tb=tb_efficiency,
        columns={
            "Year": "year",
            "Total electricity supplied (gross, major power producers) [note 2]": "total_supplied_major_power_producers",
            "Total electricity supplied (gross, all generators) [note 2]": "total_supplied_all_generators",
            "Supplied from conventional thermal and other (gross, major power producers) [note 3]": "conventional_thermal_supplied_major_power_producers",
            "Supplied from conventional thermal and other (gross, all generators) [note 3]": "conventional_thermal_supplied_all_generators",
            "Supplied from CCGT (gross, major power producers)": "ccgt_supplied_major_power_producers",
            "Supplied from CCGT (gross, all generators)": "ccgt_supplied_all_generators",
            "Supplied from nuclear (gross, major power producers)": "nuclear_supplied_major_power_producers",
            "Supplied from nuclear (gross, all generators)": "nuclear_supplied_all_generators",
            "Supplied from hydro natural flow (gross, major power producers)": "hydro_natural_flow_supplied_major_power_producers",
            "Supplied from non-thermal renewables (gross, all generators) [note 5]": "non_thermal_renewables_supplied_all_generators",
            "Supplied from hydro pumped storage (gross, all generators)": "pumped_storage_supplied_all_generators",
            "Supplied from hydro pumped storage (gross, major power producers)": "pumped_storage_supplied_major_power_producers",
