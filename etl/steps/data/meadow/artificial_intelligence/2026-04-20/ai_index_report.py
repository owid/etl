...
def run() -> None:
    ...
    with snap.extracted() as archive:
        ...
        tb_investment_corporate = tb_investment_corporate.rename(columns={"Year": "year", "Event Type": "event_type"})
        tb_investment_corporate = tb_investment_corporate.format(["year", "event_type"])
