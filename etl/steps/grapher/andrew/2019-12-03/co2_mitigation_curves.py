...
def run(dest_dir: str) -> None:
    ...
    table_1p5celsius = (
        N.garden_dataset["co2_mitigation_curves_1p5celsius"].reset_index().rename(columns={"origin": "country"})
    )
    table_2celsius = (
        N.garden_dataset["co2_mitigation_curves_2celsius"].reset_index().rename(columns={"origin": "country"})
    )
