...
DATASET_PATH = DATA_DIR / "garden" / "eia" / "2022-07-29" / "primary_energy_consumption"
...
def get_grapher_tables(dataset: catalog.Dataset) -> Iterable[catalog.Table]:
    ...
    table = dataset[dataset.table_names[0]].reset_index().drop(columns=["gdp", "population", "source"])
