...
from .shared import adapt_dataset_metadata_for_grapher, adapt_table_for_grapher
...
def get_grapher_dataset() -> catalog.Dataset:
    ...
    dataset.metadata = adapt_dataset_metadata_for_grapher(dataset.metadata)
...
def get_grapher_tables(dataset: catalog.Dataset) -> Iterable[catalog.Table]:
    ...
    table = adapt_table_for_grapher(table)
