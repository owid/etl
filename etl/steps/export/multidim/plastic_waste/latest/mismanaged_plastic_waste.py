...
def run() -> None:
    ...
    view_metadata = {
        ...
        "description_key": [
            "This pollution refers to macroplastic, meaning physical plastic pieces larger than 5 millimetres.",
            "Total plastic pollution are the sum of debris (unburned plastic that escapes into the environment as physical items) and plastic burned in open, uncontrolled fires.",
            "Pollution are plastic that is no longer contained because it escapes from collection, disposal, or recycling and enters the environment.",
            "Pollution are attributed to five land-based sources: uncollected waste, littering, losses during collection and transport, uncontrolled disposal sites (open dumps), and rejects from sorting and reprocessing.",
