...
These types describe Python method parameters (e.g. `Collection.group_views`).
"""
...
class GroupViewsConfig(_GroupViewsConfigRequired, total=False):
    ...
    view_config: dict[str, Any]  # The view config for the new choice
    view_metadata: dict[str, Any]  # The metadata for the new view
