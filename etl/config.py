...
DATA_PRODUCER_REPORT_QUARTERLY_TEMPLATE_ID = os.environ.get("DATA_PRODUCER_REPORT_QUARTERLY_TEMPLATE_ID", "")
DATA_PRODUCER_REPORT_HALFYEARLY_TEMPLATE_ID = os.environ.get("DATA_PRODUCER_REPORT_HALFYEARLY_TEMPLATE_ID", "")
DATA_PRODUCER_REPORT_YEARLY_TEMPLATE_ID = os.environ.get("DATA_PRODUCER_REPORT_YEARLY_TEMPLATE_ID", "")
