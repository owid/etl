...
from etl.collections.model import DIMENSIONS, View


def expand_catalog_paths(view: View, tables_by_name: Dict[str, List[Table]]) -> Dict[Any, Any]:
    ...
    view.indicators.expand_paths(tables_by_name)
