"""Tests for etl.viz.chart.download_package."""
...
def test_wide_table_keeps_columns_a_single_view_cannot_distinguish():
    ...
    with (
        ...
        patch(
            "etl.viz.chart.download_package.CatalogDataset",
...
def test_sub_yearly_offsets_decode_to_dates():
    ...
    """
    from etl.viz.chart.download_package import _resolve_time_column
...
def test_table_mixing_offsets_and_years_is_refused():
    ...
    from etl.viz.chart.download_package import MixedTimeGranularityError, _resolve_time_column
...
def test_same_metric_at_two_frequencies_merges_into_one_column():
    ...
    """
    from etl.viz.chart.download_package import _merge_columns_by_name
...
def test_readme_strips_detail_on_demand_links():
    ...
    """
    from etl.viz.chart.download_package import _readme
...
def test_zip_entries_are_stamped_with_the_build_date():
    ...
    from etl.viz.chart.download_package import _zip_timestamp
...
def test_indicator_section_sits_under_the_heading_that_introduces_it():
    ...
    from etl.viz.chart.download_package_format import IndicatorColumn, column_readme_text
...
def test_source_line_matches_the_citation_it_sits_next_to():
    ...
    """
    from etl.viz.chart.download_package_format import IndicatorColumn, get_attribution, get_source
...
def test_owid_alone_is_not_credited_as_processing_its_own_data():
    ...
    from etl.viz.chart.download_package_format import IndicatorColumn, get_source
