...
from etl.viz.chart.model.dimension import Dimension
from etl.viz.explorer.core import Explorer, extract_explorers_tables
...
@patch("etl.viz.explorer.core.get_mapping_paths_to_id", side_effect=mock_get_mapping_paths_to_id)
