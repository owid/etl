...
class GSheetsApi:
    ...
    def download_worksheet(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            output_path: Local path where to save the downloaded worksheet. By default it will save it in
            the execution directory under the name that was given to the worksheet on Google Drive.
            encoding: Encoding of the file, by default "utf-8"
        """
    ...
    def download_spreadsheet(
        ...
        Args:
            spreadsheet_id: ID of the spreadsheet. This is included in the URL of the spreadsheet.
            output_dir: Local directory where to store all the downloaded worksheets.
            encoding: Encoding of the file, by default "utf-8"
        """
