...
def australia_band_detail(year):
    from australia import australia_detail

    return australia_detail(year)


def nepal_band_detail(year):
    from nepal import nepal_detail

    return nepal_detail(year)


def peru_band_detail(year):
    from peru import peru_detail

    return peru_detail(year)


def malaysia_band_detail(year):
    from malaysia import malaysia_detail

    return malaysia_detail(year)


def poland_band_detail(year):
    from poland import poland_detail

    return poland_detail(year)


def canada_band_detail(year):
    from canada import canada_detail

    return canada_detail(year)


def argentina_band_detail(year):
    from argentina import argentina_detail

    return argentina_detail(year)


def uganda_band_detail(year):
    from uganda import uganda_detail

    return uganda_detail(year)
...
def greece_band_detail(year):
    from greece import greece_detail
...
def portugal_band_detail(year):
    from portugal import portugal_detail

    return portugal_detail(year)
...
DETAIL = {
    ...
    "Uganda": uganda_band_detail,
    "Argentina": argentina_band_detail,
    "Canada": canada_band_detail,
    "Poland": poland_band_detail,
    "Malaysia": malaysia_band_detail,
    "Peru": peru_band_detail,
    "Nepal": nepal_band_detail,
    "Australia": australia_band_detail,
