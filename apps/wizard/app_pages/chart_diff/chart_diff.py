...
class ChartDiff:
    ...
    modified_checksum: pd.DataFrame | None
    # Whether the chart has been edited in staging
    edited_in_staging: bool | None
    ...
    def __init__(
        ...
        self._approval_status: gm.CHART_DIFF_STATUS | str | None = None
    ...
    ) -> dict[int, gm.ChartDiffApprovals | None]:
        if ignore_conflicts:
