...
st.markdown(
    ":small[:orange-badge[:material/warning: Use this app to create a collection (previously referred as MDIMs). This app is in development. Please review the generated files.]]"
)
