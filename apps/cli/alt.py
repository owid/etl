...
@click.group(
    ...
    lazy_subcommands={
        ...
        "b fasttrack": "apps.backport.fasttrack_backport.cli",
        "b migrate": "apps.backport.migrate.migrate.cli",
        "b bulk": "apps.backport.bulk_backport.bulk_backport",
        "b run": "apps.backport.backport.backport_cli",
