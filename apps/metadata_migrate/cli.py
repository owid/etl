...
def cli(
    ...
    **Example 2:** Create YAML file in Grapher step
    ...
    if show:
        ...
        print(
            "[green]1.[/green] Pick topic tags [link=http://analytics/private?sql=SELECT%0D%0A++tags.name%0D%0AFROM%0D%0A++tags%0D%0AWHERE%0D%0A++slug+IS+NOT+NULL%0D%0AORDER+BY%0D%0A++tags.name%3B]from the list[/link].",
        )
        print(
