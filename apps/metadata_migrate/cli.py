...
def cli(
    ...
    if show:
        ...
        print(
            "[green]1.[/green] Pick topic tags [link=http://datasette-private/owid?sql=SELECT+tags.%60name%60+from+tags+where+isBulkImport+%3D+0+ORDER+BY+tags.%60name%60%0D%0A]from the list[/link].",
        )
        print(
